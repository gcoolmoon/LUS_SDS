...
class DialogManager {
    ...
    public function compare($operator, $value, $UttPercentage)
    {
        $condition_verified=false;
        switch ($operator) {
                            case '==': {
                                    if ($UttPercentage == $value) {
    ...
    public function checkUtterance($UttPercentage) {
        $dom = new DOMDocument();
        ...
        if ($confidences->length > 0) {
            foreach ($confidences as $con) {
                ...
                foreach ($conditions as $key => $condition) {
                        ...
                        $condition_verified = $this->compare($operator, $value, $UttPercentage);
    ...
    public function getResults() {
        ...
        $endpoint = 'http://94.23.251.66:8890/sparql';
